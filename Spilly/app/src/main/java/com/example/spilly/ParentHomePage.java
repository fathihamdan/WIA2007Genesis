        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (itemId == R.id.parentHomePage) {
                    ...
                    NavHostFragment.findNavController(ParentHomePage.this)
                            .navigate(R.id.action_parentHomePage_to_parentNotificationPage);
                    return true;
                } else if (itemId == R.id.parentProfilePage) {
                    NavHostFragment.findNavController(ParentHomePage.this)
                            .navigate(R.id.action_parentHomePage_to_parentProfilePage);
                    return true;
                }
                return false;
            }
